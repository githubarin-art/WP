...
function useQuizLogic() {
  // All states and handlers including the new ones
  ...
  const handleSubmit = async (event) => {
    ...
    setUserAttempts((prev) => [...prev, newAttempt]);
    setIsInfo(null);
  };
...
function App() {
  ...
  if (loading) {
    return <div className="p-8 text-center text-2xl font-semibold text-gray-700 animate-pulse">Loading questions...</div>;
  }

  if (error) {
    return <div className="p-8 text-center text-red-500 font-medium text-lg">{error}</div>;
  }
